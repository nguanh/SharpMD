...
#TODO tests laufen nur einzeln richtig, aber zusammen werden anscheinend keine daten gelöscht
class TestMatchMedium(TestCase):
    def setUp(self):
    ...
    def tearDown(self):
        pub_medium.objects.all().delete()
        pub_alias_source.objects.all().delete()
        pub_medium_alias.objects.all().delete()
